...
from util.func import STEFunction, bimodal_normal, hardmax, rescale_norm
...
class GPT2PreTrainedModel(PreTrainedModel):
	...
	def _init_weights(self, module):
		...
		if isinstance(module, (nn.Linear, Conv1D)):
			...
			module.weight.data.normal_(mean=self.config.init_mean, std=self.config.initializer_range)
